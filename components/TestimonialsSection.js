        ...
        <section id="testimonials" className="py-16 md:py-24 relative overflow-hidden bg-navy-900">
            ...
            <div className="container mx-auto relative z-10 px-4 sm:px-6 lg:px-8">
                <h2 className="text-3xl md:text-4xl lg:text-5xl font-bold text-center mb-12 md:mb-16 text-primary tracking-tight">
                    Voices of <span className="text-gray-500">Decoration</span>
                </h2>
                <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6 md:gap-8">
                    ...
                    <div className="bg-navy-800 border border-gray-700/50 p-6 md:p-8 rounded-xl relative overflow-hidden transform transition duration-300 hover:scale-105 hover:shadow-2xl group">
                        ...
                        <p className="italic mb-6 text-gray-300 leading-relaxed text-base md:text-lg">
                            "Makbea transformed my home with their stunning decor. Every piece is a conversation starter!"
                        </p>
                        <div className="flex items-center justify-between">
                            <div>
                                <h4 className="font-bold text-primary text-lg md:text-xl mb-1">Biruk Tesfaye</h4>
                                <p className="text-xs md:text-sm text-gray-500">Homeowner</p>
                            </div>
                    ...
                    <div className="bg-navy-800 border border-gray-700/50 p-6 md:p-8 rounded-xl relative overflow-hidden transform transition duration-300 hover:scale-105 hover:shadow-2xl group">
                        ...
                        <p className="italic mb-6 text-gray-300 leading-relaxed text-base md:text-lg">
                            "Makbea decor solutions have completely revitalized our workspace. It's now a place of inspiration!"
                        </p>
                        <div className="flex items-center justify-between">
                            <div>
                                <h4 className="font-bold text-primary text-lg md:text-xl mb-1">Samuel Abebe</h4>
                                <p className="text-xs md:text-sm text-gray-500">Office Manager</p>
                            </div>
                            <div className="flex space-x-1">
                                {[...Array(4)].map((_, index) => (
                                    <svg 
                    ...
                    <div className="bg-navy-800 border border-gray-700/50 p-6 md:p-8 rounded-xl relative overflow-hidden transform transition duration-300 hover:scale-105 hover:shadow-2xl group">
                        ...
                        <p className="italic mb-6 text-gray-300 leading-relaxed text-base md:text-lg">
                            "Makbea's hotel decor has elevated our hotel ambiance. Guests are always impressed by the stylish designs!"
                        </p>
                        <div className="flex items-center justify-between">
                            <div>
                                <h4 className="font-bold text-primary text-lg md:text-xl mb-1">Hana Tesfaye</h4>
                                <p className="text-xs md:text-sm text-gray-500">Hotel Manager</p>
                            </div>
                            <div className="flex space-x-1">
                                {[...Array(4)].map((_, index) => (
                                    <svg 
